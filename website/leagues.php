...
<div class="container">
    <div class="main-con">
        <div class="main-section">
            <h3>recent news in all leagues</h3>
            <?php
        ...
        <div class="side-container">
            ...
            <div class="side-con">
                <?php
                $result_leagues = leagues_();
                $count_leagues = mysqli_num_rows($result_leagues);
                if ($count_leagues > 0) {
                    while ($row_leagues = mysqli_fetch_assoc($result_leagues)) { ?>
                        <div class="left-card">
                            <div class="image">
                                <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row_leagues['leagueImage']) ?>" alt="">
                            </div>
                            <div class="content">
                                <span class="name"><?php echo $row_leagues['leagueName'] ?></span>
                                <a href="league.php?box=mainPage&leagueID=<?php echo $row_leagues['leagueID'] ?>" class="btn second-btn">view</a>
                            </div>
                        </div>
                <?php
                    }
